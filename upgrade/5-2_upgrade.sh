...
then
	...
	kubectl set image deployment/reports-viewer-deployment reports-viewer-container=gcr.io/boldreports/boldreports-viewer:$version --namespace=$namespace --record 
fi
