# How to deploy Bold Reports in Elastic Kubernetes Services (EKS) using Application Load Balancer (ALB)

The section explains how to deploy [Bold Reports](https://www.boldreports.com/) in an EKS cluster using an [Application Load Balancer](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/introduction.html).
...
6. Download the **deploy_eks_alb.yaml** file [here](../../deploy/deploy/deploy_eks_alb.yaml) to deloy Bold Reports on EKS.
